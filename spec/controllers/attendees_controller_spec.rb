  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved attendee as @attendee" do
        ...
        post :create, {:attendee => { "event_id" => "invalid value" }}, valid_session
        assigns(:attendee).should be_a_new(Attendee)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested attendee" do
        ...
        Attendee.any_instance.should_receive(:update).with({ "event_id" => "" })
        put :update, {:id => attendee.to_param, :attendee => { "event_id" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the attendee as @attendee" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Attendee.any_instance.stub(:save).and_return(false)
        put :update, {:id => attendee.to_param, :attendee => { "event_id" => "invalid value" }}, valid_session
        assigns(:attendee).should eq(attendee)
      end
